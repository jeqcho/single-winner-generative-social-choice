...
- 4-letter hash identifiers to disentangle from rank positions
- Degeneracy detection with retry logic
...
def iterative_rank(
    ...
    bottom_rankings = []   # Accumulate bottom selections (in reverse order)
    ...
    for round_num in range(1, N_ROUNDS + 1):
        ...
        if round_num < N_ROUNDS:
            ...
            bottom_rankings = bottom_k_ids + bottom_rankings  # Prepend (reverse order)
