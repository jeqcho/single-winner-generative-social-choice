...
def plot_predicted_vs_original_scatter_binned(topics: List[str], bin_size: int = 5) -> None:
    ...
    ax.set_title('Chunked Insertion: Binned Reconstructed vs Original', fontsize=18)
    ...
    plt.tight_layout()
    plt.savefig(FIGURES_DIR / "chunked_scatter_binned.png", dpi=300, bbox_inches='tight')
    plt.close()
    logger.info(f"Saved chunked_scatter_binned.png")
