"""
Compute epsilon values with respect to 100 personas using winners from 20 personas.

This module provides functions to compute and collect epsilon-100 values,
which measure how well a winner (selected using 20 sampled personas) performs
